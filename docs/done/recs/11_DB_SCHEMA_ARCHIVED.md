# 11. Database & Application Platform — Schema

Parent: [11_DB_REQUIREMENTS.md](11_DB_REQUIREMENTS.md)
...
| `recipe` | `JSONB` | Slot-to-source mapping. `NOT NULL`. See [11.1_RECIPE_GENERATION_SYSTEM.md](11.1_RECIPE_GENERATION_SYSTEM.md). |
