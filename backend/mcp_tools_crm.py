"""MCP tool functions for CRM: relationship stages, health scores, touchpoints, networking tasks.

Orchestrator note: call register_crm_tools(mcp) in mcp_server.py.
"""
...
def register_crm_tools(mcp):
    """Register all CRM MCP tools with the given MCP server instance."""
