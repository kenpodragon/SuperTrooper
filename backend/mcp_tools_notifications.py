"""MCP tool functions for notifications.

Orchestrator note: call register_notifications_tools(mcp) in mcp_server.py.
"""
...
def register_notifications_tools(mcp):
    """Register all notification MCP tools with the given MCP server instance."""
