"""MCP tool definitions for Search Intelligence & Email Intelligence.
...
Usage in mcp_server.py:
    import mcp_tools_search_intel  # noqa: F401  (side-effect: registers tools)
"""
...
def quick_fit_score(jd_text: str | None = None, fresh_job_id: int | None = None) -> dict:
    ...
    # Find common demanded skills we lack
    common_skills = [
