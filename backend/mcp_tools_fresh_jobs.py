"""MCP tool functions for the fresh jobs inbox: get, triage, batch triage.

Orchestrator note: call register_fresh_jobs_tools(mcp) in mcp_server.py.
"""
...
def register_fresh_jobs_tools(mcp):
    """Register all fresh-jobs MCP tools with the given MCP server instance."""
