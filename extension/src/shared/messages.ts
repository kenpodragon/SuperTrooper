...
export const MSG = {
  ...
  ATS_FILL: "ATS_FILL",
  LINKEDIN_CONTACTS_DETECTED: "LINKEDIN_CONTACTS_DETECTED",
  GET_LINKEDIN_CONTACTS: "GET_LINKEDIN_CONTACTS",
  LOOKUP_LINKEDIN_CONTACT: "LOOKUP_LINKEDIN_CONTACT",
  CREATE_LINKEDIN_CONTACT: "CREATE_LINKEDIN_CONTACT",
} as const;
